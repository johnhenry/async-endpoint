 ...
 */
export { default as composeProgram } from "./compose-programs.mjs";
 ...
 * ...
 */
export { default as map } from "./array-like/map.mjs";
 ...
 * ...
 */
export { default as forEach } from "./array-like/for-each.mjs";
 ...
 * logs "5"
 */
export { default as filter } from "./array-like/filter.mjs";
 ...
 * @example
 * import {pause} from "async-endopint.mjs";
 * const main = async ()=>{
 *  console.log("hello");
 *  await pause(1000);
 *  console.log("goodbye");
 ...
 * @example
 * import {composeAsyncTransformer} from "async-endopint.mjs";
 * const t1 = async (x)=>`<${x}>`;
 * const t2 = async (x)=>`[${x}]`;
...
} from "./compose-async-transformers.mjs";
 ...
 * render(queue);
 */
export { default as createQueue } from "./queue/create-queue.mjs";
 ...
 * render(stack);
 */
export { default as createStack } from "./queue/create-stack.mjs";
 ...
 * render(queue);
 */
export { default as programQueue } from "./queue/create-program-queue.mjs";
 ...
 * render(stack);
 */
export { default as programStack } from "./queue/create-program-queue.mjs";
 ...
 * window.respond = respond
 */
export { default as identity } from "./program/identity.mjs";
 ...
 * ...
 */
export { default as continuousOutput } from "./program/continuous-output.mjs";
 ...
 * @example
 * import {renderer, continuousOutput} from "async-input.mjs";
 * const render = renderer();
 ...
 */
export { default as tee } from "./renderer/tee.mjs";
