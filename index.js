 ...
 * //logs "<[hello]>"
 */
export { default as composeAsyncTransformer } from "./sub-modules/compose-async-transformers";
 ...
 * render(queue);
 */
export { default as queue } from "./sub-modules/create-queue";
 ...
 * render(stack);
 */
export { default as stack } from "./sub-modules/queue/create-stack";
 ...
 * render(queue);
 */
export { default as programQueue } from "./sub-modules/queue/program-queue";
 ...
 * render(stack);
 */
export { default as programStack } from "./sub-modules/queue/program-queue";
 ...
 * ...
 */
export { default as continuousOutput } from "./sub-modules/program/continuous-output";
